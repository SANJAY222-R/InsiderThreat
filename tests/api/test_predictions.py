...
class TestPredictionEndpoints:
    ...
    @pytest.mark.api
    def test_predict_single_employee(self, client, auth_headers, sample_prediction_payload) -> None:
    ...
    @pytest.mark.api
    def test_get_predictions_list(self, client, auth_headers) -> None:
    ...
    @pytest.mark.api
    def test_get_prediction_by_id(self, client, auth_headers) -> None:
    ...
    @pytest.mark.api
    def test_get_prediction_not_found(self, client, auth_headers) -> None:
        response = client.get("/api/v1/predictions/99999", headers=auth_headers)
        assert response.status_code == 404

    @pytest.mark.api
    def test_predictions_list_contains_seeded_data(self, client, auth_headers) -> None:
        response = client.get("/api/v1/predictions/", headers=auth_headers)
        assert response.status_code == 200
